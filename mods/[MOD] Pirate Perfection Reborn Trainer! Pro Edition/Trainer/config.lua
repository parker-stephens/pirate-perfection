-- Pirate Perfection Reborn Trainer! Pro Edition Main Configuration File.
...
-- General Options
 ...
 -- Spoof Options	
	NameSpoof = "A fellow Pro Pirate",		-- Your new name in game, set to false in order to use your steam name. Don't forget to write your name in "Quotation Marks" (V.I.P. only Function)
...
-- Tweaks - For Advanced Users only!			-- Toggle here the Tweaks you want to enable.
 ...
 -- Custom Safehouse
	SafeHouseDoors = true,							-- Makes doors actually doors in the Safe House. (V.I.P. Only)
