...
backuper:hijack('TipsTweakData.get_a_tip', function(o, s)
	return math.random() > 0.8 and {image = "general_loot", index = 1, total = 1, title = "Pirate Perfection Reborn Trainer! Pro Edition", text = "Trainer: v2.0.0-PaE\nSuperBLT: v3.1.2 (R026)\nCreator: Baddog-11\nVisit us at www.Pirateperfection.com"} or o(s)
end)
