...
ppr_io.open = function( file, mode )
	file = "mods/[MOD] Pirate Perfection Reborn Trainer! Pro Edition/" .. file
...
ppr_io.io_popen = function( command )
	command = command:gsub("Trainer/", "mods/[MOD] Pirate Perfection Reborn Trainer! Pro Edition/Trainer/")
